...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>airports</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class AirportsExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.airports"));
				WorldMap root = AirportsFactory.eINSTANCE.createWorldMap();
